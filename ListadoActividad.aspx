<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListadoActividad.aspx.cs" Inherits="TOVISIT.APP.ListadoActividad" %>
                                        ...
                                        <td>
                                            <table class="margenCero, paddingCero" cellpadding="0" cellspacing="0">
                                                <tr>
                                                 ...
                                                 <asp:GridView ID="gvActividad" runat="server" CssClass="mGrid" AutoGenerateColumns="False" Width="103%"   OnRowDataBound="gvActividad_RowDataBound"  DataKeyNames="ID_ACTIVIDAD"  OnSelectedIndexChanging="gvActividad_SelectedIndexChanging" OnRowDeleting="gvActividad_RowDeleting" OnSelectedIndexChanged="gvActividad_SelectedIndexChanged"  >
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="ID_ACTIVIDAD" HeaderText="No." SortExpression="ID_LUGAR" />
                                                                 <asp:BoundField DataField="USUARIO" HeaderText="Usuario" SortExpression="USUARIO" />
                                                                <asp:BoundField DataField="NOMBRE_LUGAR" HeaderText="Nombre Lugar" SortExpression="Nombre Lugar" />
                                                               <asp:BoundField DataField="NOMBRE_ACTIVIDAD" HeaderText="Nombre Actividad" SortExpression="Nombre Actividad" />
                                                                <asp:BoundField DataField="DESCRIPCION_ACTIVIDAD" HeaderText="Descripción Actividad" SortExpression="Descripción Actividad" />
                                                                <asp:BoundField DataField="FECHA_INICIO" HeaderText="Fecha Inicio" SortExpression="Fecha Inicio" />
                                                                <asp:BoundField DataField="FECHA_FIN" HeaderText="Fecha Fin" SortExpression="Fecha Fin" />
