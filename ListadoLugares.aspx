<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListadoLugares.aspx.cs" Inherits="TOVISIT.APP.ListadoLugares" %>
                                        ...
                                        <td>
                                            <table class="margenCero, paddingCero" cellpadding="0" cellspacing="0">
                                                <tr>
                                                 ...
                                                 <asp:GridView ID="gvLugar" runat="server" CssClass="mGrid" AutoGenerateColumns="False" Width="103%"   OnRowDataBound="gvLugar_RowDataBound"  DataKeyNames="ID_LUGAR"  OnSelectedIndexChanging="gvLugar_SelectedIndexChanging"  >
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="ID_LUGAR" HeaderText="No." SortExpression="ID_LUGAR" />
                                                                <asp:BoundField DataField="DESCRIPCION" HeaderText="Descripción Tipo Lugar" SortExpression="ID_TIPO_LUGAR" />
                                                                <asp:BoundField DataField="USUARIO" HeaderText="Usuario" SortExpression="USUARIO" />
                                                                <asp:BoundField DataField="NOMBRE_LUGAR" HeaderText="Nombre Lugar" SortExpression="Nombre Lugar" />
                                                                <asp:BoundField DataField="DESCRIPCION_LUGAR" HeaderText="Descripción Lugar" SortExpression="Descripción Lugar" />
                                                                <asp:BoundField DataField="IMAGEN_LUGAR" HeaderText="Imagen" SortExpression="Imagen" />
                                                                <asp:BoundField DataField="COORDENADAS" HeaderText="Coordenadas" SortExpression="Coordenadas" />
                                                                <asp:BoundField DataField="LAT" HeaderText="Latitud" SortExpression="Latitud" />
                                                                <asp:BoundField DataField="LNG" HeaderText="Longitud" SortExpression="Longitud" />
