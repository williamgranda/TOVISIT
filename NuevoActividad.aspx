<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NuevoActividad.aspx.cs" Inherits="TOVISIT.APP.NuevoActividad" %>
                    ...
                    <table class="margenCero, paddingCero" cellpadding="0" cellspacing="0" style="overflow: hidden; width: 100%">
                        <tr>
                            <td>
                                ...
                                <h3>Crear - Editar Actividades</h3>
                                    ...
                                    <tr>
                                        <td>
                                            <table class="margenCero, paddingCero" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td class="celdasSeparadas">Nombre Actividad:</td>
                                                    <td class="celdasSeparadas">
                                                        <asp:TextBox ID="txtActividad" runat="server" Width="231px"></asp:TextBox>

                                                    </td>
                                                    <td class="celdasSeparadas">&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    <td class="celdasSeparadas">&nbsp;Lugar:</td>
                                                     <td class="celdasSeparadas">
                                                                <asp:DropDownList CssClass="dropdownlist" ID="ddlLugar" runat="server" Width="200px" ></asp:DropDownList>
                                                            </td>
                                                </tr>
                                                <tr>

                                                    <td class="celdasSeparadas">Descripción Actividad:</td>
                                                    <td class="celdasSeparadas">
                                                    ...
                                                    <tr>
                                                        <td class="celdasSeparadas">Fecha Inicio:</td>
                                                        <td class="celdasSeparadas">
                                                             <asp:TextBox ID="txtFechainicio"  MaxLength="10"  placeholder="aaaa-mm-dd" TextMode="Date"  runat="server" Width="231px"></asp:TextBox>
                                                        </td>
                                                </tr>
                                                <tr>
                                                    <td class="celdasSeparadas">Fecha Fin:</td>
                                                    <td class="celdasSeparadas">
                                                         <asp:TextBox ID="txtFechafinal"  MaxLength="10" runat="server" placeholder="aaaa-mm-dd" TextMode="Date"  Width="231px"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="celdasSeparadas">&nbsp;</td>
                                                ...
                                                <tr>
                                                    <td align="center" class="auto-style2" colspan="2" style="padding-top: 30px">
                                                        &nbsp;&nbsp;<asp:Button ID="btnGuardar" runat="server" CssClass="button-gray" Font-Bold="true"  Text="Guardar" Width="120px" OnClick="btnGuardar_Click" />
