<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NuevoTipo.aspx.cs" Inherits="TOVISIT.APP.NuevoTipo" %>
                    ...
                    <table class="margenCero, paddingCero" cellpadding="0" cellspacing="0" style="overflow: hidden; width: 100%">
                        <tr>
                            <td>
                                ...
                                <h3>Crear - Editar Tipo de Lugares</h3>
                                            ...
                                            <table class="margenCero, paddingCero" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td class="celdasSeparadas">
                                                        <asp:TextBox ID="txtDescripcion" runat="server" Width="298px" ></asp:TextBox>
