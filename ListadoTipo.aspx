<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListadoTipo.aspx.cs" Inherits="TOVISIT.APP.ListadoTipo" %>
                                        ...
                                        <td>
                                            <table class="margenCero, paddingCero" cellpadding="0" cellspacing="0">
                                                <tr>
                                                 ...
                                                 <asp:GridView ID="gvTipo" runat="server" CssClass="mGrid" AutoGenerateColumns="False" Width="103%"   OnRowDataBound="gvTipo_RowDataBound"  DataKeyNames="ID_TIPO_LUGAR"  OnSelectedIndexChanging="gvTipo_SelectedIndexChanging"  >
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="ID_TIPO_LUGAR" HeaderText="No."  SortExpression="CODIGO" />
                                                                <asp:BoundField DataField="DESCRIPCION" HeaderText="Descripción Tipo Lugar" SortExpression="Descripción" />                                                               
